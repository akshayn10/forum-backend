...
public class VoteService {
    ...
    public void vote(VoteDto voteDto) {
        ...
        Optional<Vote> voteByPostAndUser = voteRepository.findTopByPostAndForumUserOrderByVoteIdDesc(post, authService.getCurrentUser());
    ...
    private Vote mapToVote(VoteDto voteDto, Post post) {
        return Vote.builder()
                ...
                .post(post)
                .forumUser(authService.getCurrentUser())
                .build();
    }
}